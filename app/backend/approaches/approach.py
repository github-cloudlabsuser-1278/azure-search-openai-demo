...
Functions:
    ...
    Approach.get_citation: Generates a citation string based on the source page.
    ...
    Approach.run: Abstract method to be implemented for running the approach with given messages and context.
